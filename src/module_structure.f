...
!-- enkf_parameter
   ...
   real          :: inflate             !
   real          :: mixing              !
   logical       :: use_vortex_RTPP     !.true.:use different mixing coeff for inner-core and env
   real          :: mixing_core 
   real          :: mixing_param 
   real          :: mixing_alpha, mixing_beta, mixing_vc 
...
!-- use_radiance
   ...
   logical       :: use_inf_bt          ! .true. : apply Empirical BT-based inflation
...
!-- Namelist contents :
   ...
   namelist /enkf_parameter / numbers_en, expername, enkfvar, updatevar,                          &
                                 ...
                                 inflate, mixing, use_vortex_RTPP, mixing_core, mixing_param,  &
                                 mixing_alpha, mixing_beta, mixing_vc, &
                                 random_order, print_detail
...
namelist /radiance/use_radiance,datathin_radiance,hroi_radiance,vroi_radiance,use_vroi_radiance_halfsfc,use_aoei,use_elf,use_inf_bt
