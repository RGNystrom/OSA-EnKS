...
!-- estimate_sfc_params
! Parameter Estimation for Surface Exchange Coefficients
   estimate_sfc_params = .false. 
...
!-- enkf_parameter
   ...
   if ( my_proc_id == 0 ) then
      ...
      if ( use_vortex_RTPP ) then
         write(6,'(a,3x,f5.2   )') ' mixing_core = ',mixing_core  
         write(6,'(a,3x,f5.2   )') ' mixing_param = ',mixing_param
         write(6,'(a,3x,f5.2   )') ' mixing_alpha = ',mixing_alpha
         write(6,'(a,3x,f5.2   )') ' mixing_beta = ',mixing_beta
         write(6,'(a,3x,f5.2   )') ' mixing_vc = ',mixing_vc
      end if
...
subroutine wrf_var_dimension ( wrf_file, var, ix, jx, kx, ii, jj, kk )
   ...
   if      ( var == 'U         ' ) then
      ...
      kk = kx + 1
        ...
        .or. var == 'V10       ' .or. var == 'SFC_ALPHA ' .or. var == 'SFC_VC    '  &
        .or. var == 'SFC_BETA  ') then
      kk = 1
